        ...
        <div className="flex items-center justify-between  h-full">
          ...
          <div className="flex items-center">
            ...
            <nav className="hidden md:flex space-x-4 lg:space-x-6 xl:space-x-10 text-primary ">
              <Link
                ...
                className="text-sm whitespace-nowrap hover:text-primaryHover transition-colors"
              >
                Каталог
              </Link>
              <Link
          ...
          <div className="flex items-center space-x-3 md:space-x-5 lg:space-x-10">
            <div className="hidden lg:block flex-shrink-0">
              <a href="tel:+79134702311" target="_blank" className="text-sm text-primary whitespace-nowrap">
                8 (913) 470-23-11
              </a>
            </div>
