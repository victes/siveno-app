        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 md:space-x-5 lg:space-x-10">
            ...
            <div className="hidden sm:flex items-center space-x-3">
              <a href="https://t.me/+pnsEBODRdPJiNmNi" className="text-gray-500 hover:text-black transition-colors" target="_blank" rel="noopener noreferrer">
                <FaTelegram size={18} />
              </a>
              <a href="https://vk.com/siveno.store" className="text-gray-500 hover:text-black transition-colors" target="_blank" rel="noopener noreferrer">
