...
const faq = [
  ...
  },
  {
    ...
    value: `Вы можете вернуть товар в течение 14 дней с момента получения, если он не был в использовании и сохранен товарный вид. Для оформления возврата свяжитесь с нами по почте info@example.com или через WhatsApp +7XXXXXXXXXX.`,
  },
  {
