        ...
        <div className="fixed top-0 left-0 h-screen w-screen bg-black/70 backdrop-blur-md z-50 p-[20px] md:p-[40px] overflow-y-auto">
          <div className="flex justify-between items-center mb-10">
            ...
            <div className="flex items-center space-x-6">
              <a href="https://t.me/+pnsEBODRdPJiNmNi" className="text-white hover:text-gray-300 transition-colors" target="_blank" rel="noopener noreferrer">
                <FaTelegram size={24} />
              </a>
              <a href="https://vk.com/siveno.store" className="text-white hover:text-gray-300 transition-colors" target="_blank" rel="noopener noreferrer">
