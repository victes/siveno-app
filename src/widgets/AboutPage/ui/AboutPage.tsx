      ...
      <div className="flex flex-col gap-[20px] mt-[60px]">
        ...
        >
          ...
          <motion.div className="max-w-[850px] mindesk:max-w-[450px] w-full" variants={fadeIn("right", 0.5)}>
            ...
            >
              Мы создаем не просто вещи, а пространство для женщины, которая ценит гармонию в жизни и качество в вещах. Siveno – это про уверенность быть собой, про внутреннюю силу, которая не требует громких слов.
            </motion.p>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.div className="max-w-[850px] mindesk:max-w-[450px] text-right w-full" variants={fadeIn("left", 0.3)}>
            <motion.h2
              ...
              transition={{ duration: 0.8 }}
            >
              Наши коллекции – это продуманный баланс стиля, удобства и премиального качества. Мы выбираем лучшие ткани, уделяем внимание каждой детали и создаем одежду, которая подчеркивает вашу самодостаточность и естественную красоту.
            </motion.h2>
            <motion.p
              className="text-[20px] tablet:text-[25px] laptop:text-[30px] text-text bona"
              initial={{ opacity: 0 }}
              ...
              transition={{ duration: 1, delay: 0.3 }}
            >
              Добро пожаловать в мир женственности, уверенности и свободы быть собой.
            </motion.p>
          </motion.div>
          <div className="relative">
