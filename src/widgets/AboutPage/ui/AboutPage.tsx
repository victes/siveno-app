        ...
        >
          ...
          <motion.div className="max-w-[850px] mindesk:max-w-[450px] w-full" variants={fadeIn("right", 0.5)}>
            ...
            >
              ...
              вопрос — мой гардероб. <br /><br />Я обновила его, но чего-то не хватало. Хотелось лёгкости, свободы,
              осознанности. Так родилась идея: создать свой бренд одежды. Бренд, который решает сразу две мои задачи —
              стиль и движение. Ведь мода не терпит статичности: выбор тканей, разработка моделей, поиск лучших решений
              — это бесконечный процесс, полный вдохновения.
            </motion.p>
          </motion.div>
        </motion.div>
