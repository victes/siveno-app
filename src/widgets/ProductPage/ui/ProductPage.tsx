...
const ProductPage = () => {
  ...
  const accordion = [
    ...
    },
    {
      name: "Размеры",
      value:
        products?.preference && Object.keys(products.preference).length > 0 ? (
            ...
            <tbody>
              <tr>
                ...
                {products.preference.map((item, idx) => (
                  <td key={idx} className="text-center border-2 p-2 font-bold">
                    {item.size_label}
                  </td>
                ))}
              </tr>
              <tr>
                ...
                {products.preference.map((item, idx) => (
                  <td key={idx} className="text-center border-2 p-2">
                    {item.chest}
                  </td>
                ))}
              </tr>
              ...
              <tr>
                ...
                <td className="text-center border-2 p-2" colSpan={100}>
                  164-174
                </td>
              </tr>
            </tbody>
    ...
    },
    {
      name: "Обмеры",
      value:
        products?.size_characteristics && products.size_characteristics.length > 0 ? (
          <table className="border-[#dedede] border-2 w-full h-auto">
            <tbody>
            ...
            <div className="product-page__price_block flex flex-row-reverse">
              {products.discount_percent && products.discount_percent > 0 && (
                <p className="product-page_discount">
                  <span className="text-gray-500 opacity-75 line-through">
                    {Number(products.original_price).toFixed()} ₽
                  </span>
