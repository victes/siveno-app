...
const LoginPage = () => {
  ...
  return (
    <div className="space-y-4 min-w-[220px] lg:min-w-[450px] mt-4 my-10">
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col mx-auto items-center gap-4 max-w-[500px]">
        {/* Email Field */}
        <div className="flex flex-col space-y-2 w-full">
          <label className="input input-bordered bg-transparent flex items-center gap-2">
            ...
            <input type="text" className="grow" placeholder="Email" {...form.register("email")} />
          </label>
